<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customer_AttendanceHistory.aspx.cs" Inherits="ShaistaFinalProject.Customer_AttendanceHistory" %>
...
<div class="row">
  ...
  <h2>Online Hostel Mess Management:<asp:Label ID="Label1" runat="server" CssClass="auto-style1" Text="Label"></asp:Label> </h2>
    <h3>Customer Attendance History</h3>
