<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="ShaistaFinalProject.Admin" %>
...
<div class="row">
  <div class="col-3 col-s-3 menu">
    <ul>
      ...
      <li>
         ...
         <li><asp:HyperLink ID="HyperLink6" runat="server" NavigateUrl="~/AdminMenue.aspx">Manage Menus</asp:HyperLink></li>
  ...
  <div class="col-6 col-s-9">
        ...
        <table align="center" class="col-s-12">
          ...
          <tr>
              <td class="auto-style5" colspan="2"><strong>Customer Feedbacks</strong></td>
              <td class="auto-style3">&nbsp;</td>
          </tr>
          <tr>
              <td colspan="2">
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ShaistaFinalDBConnectionString %>" SelectCommand="SELECT DISTINCT [customerid], [message], [date] FROM [feedbacks]"></asp:SqlDataSource>
              </td>
              <td class="auto-style3">&nbsp;</td>
          </tr>
          <tr>
